...
const UpdateCarForm = ({ car, onSubmit, onClose, error }) => {
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    className={`block w-full text-gray-700 border ${formik.touched.carNumber && formik.errors.carNumber ? "border-red-500" : "border-gray-300"} rounded py-3 px-4 leading-tight`}
            ...
            <div>
                ...
                <input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className={`block w-full text-gray-700 border ${formik.touched.model && formik.errors.model ? "border-red-500" : "border-gray-300"} rounded py-3 px-4 leading-tight`}
